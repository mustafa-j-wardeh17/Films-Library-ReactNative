...
import { View, Text, Pressable, TextInput, Button, TouchableOpacity, StyleSheet, Image, TouchableWithoutFeedback, Keyboard } from "react-native";
    ...
    return (
        ...
        >
            <View
                ...
                />
                {/* <LinearGradient
                    className='w-[70%] h-[4px] bg-gray-300 rounded-4xl'
                    colors={['rgba(110, 15, 15, 1)', 'rgba(0, 0, 0, 1)']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
                    locations={[0, 0.73]} // Adjust the stops here
                /> */}
            </View>
            <View className=" bottom-0 px-4 w-full max-w-sm" style={{ marginBottom: hp(12) }} >
